...
<p align="center">
<a href="https://kitura-next.github.io/SwiftKafka/index.html">
<img src="https://img.shields.io/badge/apidoc-SwiftKafka-1FBCE4.svg?style=flat" alt="APIDoc">
</a>
<a href="https://travis-ci.org/Kitura-Next/SwiftKafka">
<img src="https://travis-ci.org/Kitura-Next/SwiftKafka.svg?branch=master" alt="Build Status - Master">
</a>
...
#### Add dependencies
Add the `SwiftKafka` package to the dependencies within your application’s `Package.swift` file. Substitute `"x.x.x"` with the latest `SwiftKafka` [release](https://github.com/Kitura-Next/SwiftKafka/releases).
```swift
...
## API Documentation
For more information visit our [API reference](https://kitura-next.github.io/Swift-Kafka/index.html).
...
## License
This library is licensed under Apache 2.0. Full license text is available in [LICENSE](https://github.com/Kitura-Next/Swift-Kafka/blob/master/LICENSE).
